...
import { notificationService, NotificationSettings } from '@/features/notifications/services';
      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          {renderSettingItem(
            ...
            'Randevu talepleri, onayları ve hatırlatmaları',
            'calendar-outline',
            !settings.pushNotifications
          )}
          ...
          {renderSettingItem(
            ...
            'Ödeme Bildirimleri',
            'Ödeme onayları ve kazanç bildirimleri',
            'card-outline',
            !settings.pushNotifications
          )}
          ...
          {renderSettingItem(
            ...
            'Mesaj Bildirimleri',
            'Müşteri mesajları ve sohbet bildirimleri',
            'chatbubble-outline',
            !settings.pushNotifications
          )}
