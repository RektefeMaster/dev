...
import { Button, Card, LoadingSpinner, EmptyState, StatsCard, BackButton } from '../components';
...
export default function WalletScreen() {
  ...
  const fetchWalletData = async () => {
    try {
      ...
      console.log('🔍 WalletScreen: fetchWalletData başladı');
      ...
      if (walletRes.success) {
        console.log('🔍 WalletScreen: Wallet data set ediliyor:', walletRes.data);
        setWalletData({
        ...
        console.log('❌ WalletScreen: Wallet API Response hatası:', walletRes);
        setWalletData({
          balance: 0,
          totalEarnings: 0,
          pendingAmount: 0,
      ...
      if (transactionsRes.success) {
        console.log('🔍 WalletScreen: Transactions data set ediliyor:', transactionsRes.data);
        setTransactions(transactionsRes.data || []);
      } else {
        console.log('❌ WalletScreen: Transactions API Response hatası:', transactionsRes);
        setTransactions([]);
      }
    } catch (error: any) {
      console.error('❌ WalletScreen: Wallet data fetch error:', error);
      setWalletData({
        balance: 0,
        totalEarnings: 0,
        pendingAmount: 0,
