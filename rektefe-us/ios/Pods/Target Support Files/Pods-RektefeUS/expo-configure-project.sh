...
with_node \
  ...
  --target "/Users/aydin/Desktop/dev./rektefe-us/ios/Pods/Target Support Files/Pods-RektefeUS/ExpoModulesProvider.swift" \
  --entitlement "/Users/aydin/Desktop/dev./rektefe-us/ios/RektefeUS/RektefeUS.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-blur" "expo-constants" "expo-file-system" "expo-font" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-location" "expo-print"
