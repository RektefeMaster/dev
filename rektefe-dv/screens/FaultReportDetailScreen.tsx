  ...
  const checkAppointmentStatus = async () => {
    try {
      ...
      if (response.data.success && response.data.data) {
        ...
        console.log('Randevu durumu:', appointment.status, 'Ödeme durumu:', appointment.paymentStatus);
      ...
      console.log('Randevu durumu kontrol edilemedi:', error);
      setAppointmentStatus('none');
    }
  };
              ...
              <View key={index} style={[styles.responseCard, { backgroundColor: theme.colors.background.secondary, borderColor: theme.colors.border.primary }]}>
                ...
                {response.responseType === 'contact_me' && (
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      console.log('🔍 FaultReportDetail: İletişime Geç butonuna basıldı, response:', response);
