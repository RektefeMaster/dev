...
const MechanicDetailScreen: React.FC = () => {
  ...
  console.log('🔍 MechanicDetailScreen: Component render edildi');
  console.log('🔍 Route params:', route.params);
  console.log('🔍 Mechanic data:', mechanic);
  
  // Mechanic verisi yoksa geri dön
  if (!mechanic) {
    console.log('❌ Mechanic verisi bulunamadı, geri dönülüyor');
    navigation.goBack();
    return null;
  }
  ...
  const loadMechanicDetails = async () => {
    console.log('🔍 loadMechanicDetails: Fonksiyon başladı');
    console.log('🔍 mechanic parametresi:', mechanic);
    ...
    try {
      ...
      const mockData = {
        ...
        totalJobs: 1247,
        experience: 8,
        specialties: ['Tamir ve Bakım', 'Motor Bakımı', 'Fren Sistemi', 'Elektrik'],
        reviews: [
          {
            id: 1,
            userName: 'Ahmet Y.',
      ...
      console.log('🔍 Mock data oluşturuldu:', mockData);
      setMechanicDetails(mockData);
      console.log('✅ setMechanicDetails çağrıldı');
  ...
  console.log('🔍 Render kontrolü - loading:', loading);
  console.log('🔍 Render kontrolü - mechanicDetails:', mechanicDetails);
  console.log('🔍 Render kontrolü - mechanic:', mechanic);
  ...
  console.log('🔍 currentMechanic:', currentMechanic);
  console.log('🔍 currentMechanic.name:', currentMechanic?.name);
  console.log('🔍 currentMechanic.surname:', currentMechanic?.surname);
