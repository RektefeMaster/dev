...
const createTestNotifications = async () => {
  try {
    ...
    // testdv@gmail.com kullanıcısının ID'si
    const driverId = new mongoose.Types.ObjectId('68bf50ce5237a5838c227d51');
    console.log(`Test bildirimleri oluşturulacak kullanıcı: testdv@gmail.com (${driverId})`);
