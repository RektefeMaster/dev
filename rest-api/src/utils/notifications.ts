...
export const sendNotification = async (
  ...
  title: string,
  message: string,
  type: 'appointment_request' | 'appointment_confirmed' | 'appointment_rejected' | 'reminder' | 'system' | 'fault_report' | 'towing_request' | 'payment_received' | 'payment_pending' | 'new_message' | 'quote_received' | 'quote_selected' | 'quote_accepted' | 'quote_rejected' | 'bodywork_quote_sent' | 'bodywork_quote_accepted' | 'bodywork_quote_rejected' | 'bodywork_stage_update' | 'bodywork_approval_request' | 'bodywork_job_completed',
