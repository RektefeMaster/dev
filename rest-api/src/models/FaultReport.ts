...
const FaultReportSchema: Schema = new Schema({
  ...
  serviceCategory: { 
    type: String, 
    required: true,
    enum: ['Ağır Bakım', 'Üst Takım', 'Alt Takım', 'Kaporta/Boya', 'Elektrik-Elektronik', 'Yedek Parça', 'Lastik', 'Egzoz & Emisyon', 'Araç Yıkama', 'Genel Bakım', 'Tamir ve Bakım', 'Çekici', 'repair', 'tire', 'wash', 'towing']
  },
